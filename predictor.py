...
class Route:
	def __init__(self, route_num, template, data_files):
		...
		self.template = formatTemplate.formatTemplateFile(template)
		self.data_files = data_files
		self.master = data_to_loops(self.template, formatGarmin.formatGarminFilesToUniversal(self.data_files))
		self.reg = linear_model.LinearRegression()
		print("[FORMATTING FOR PREDICTION]")
		#TODO: look at the format function for bugs
